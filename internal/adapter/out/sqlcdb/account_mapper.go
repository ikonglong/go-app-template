...
import (
	...
	sqlcgen "go-app-template/internal/adapter/out/sqlcdb/gen"
	"go-app-template/internal/domain"
)

// AccountMapper translates domain.Account ↔ sqlcgen.Account. It is the home
...
// option here.
func (*AccountMapper) ToRecord(a *domain.Account) *sqlcgen.Account {
	b := &recordBuilder{}
	a.Accept(b)
	return &b.rec
}

func (*AccountMapper) ToDomain(r *sqlcgen.Account) *domain.Account {
...
// fields into a sqlcgen.Account. It deliberately implements every visitor
...
func (b *recordBuilder) EmailVerified(verified bool) { b.rec.EmailVerified = verified }
...
var (
	_ IMapper[domain.Account, sqlcgen.Account] = (*AccountMapper)(nil)
